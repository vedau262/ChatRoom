...
public class ShapeBaseView extends CardView {
    ...
    public ShapeBaseView(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public ShapeBaseView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ShapeBaseView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
